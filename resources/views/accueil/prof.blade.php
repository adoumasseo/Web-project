...
<body>
        ...
        <div class="infos-container">
            <div class="info left-info">
                <div class="content">
                    ...
                    <button class="btn transparent modal-btn modal-trigger" id="marks-btn">Fiches de Notes</button>

                    <img src="./images/undraw_professor_re_mj1s.svg" alt="" class="image">
                </div>
            </div>
    ...
    <div class="modal-container">
        ...
        <div class="modal">
            ...
            <h1>Fiches de notes</h1>
            <h4 class="lycee-name">Nom du lycée</h4>
            <div class="infos-eleve">
                <div class="eleve-content">
                    <div class="info nom"><span>Nom du prof:</span> Mr Latouche</div>
                    <hr>
                </div>
                <div class="eleve-content">
                    <div class="info annee"><span>Année scolaire:</span> 755-756</div>
                    <hr>
                </div>
                <div class="eleve-content">
                    <div class="info conseiller"><span>Matière:</span> Mathématique </div>
                    <hr>
                </div>
                <div class="eleve-content">
            ...
            <div class="bulletin head">
                <div class="bulletin-component">Elèves</div>
            ...
            <div class="bulletin line">
                <div class="bulletin-component">LAOUROU Angelin</div>
